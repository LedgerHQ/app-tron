...
#define protocol_CancelAllUnfreezeV2Contract_init_default {{{NULL}, NULL}}
...
#define protocol_CancelAllUnfreezeV2Contract_init_zero {{{NULL}, NULL}}
...
X(a, CALLBACK, SINGULAR, BYTES,    owner_address,     1)
#define protocol_CancelAllUnfreezeV2Contract_CALLBACK pb_default_field_callback
...
/* protocol_CancelAllUnfreezeV2Contract_size depends on runtime parameters */
